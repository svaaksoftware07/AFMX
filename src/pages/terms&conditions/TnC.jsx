...
const TnC = () => {
  return (
    <>
      <div className="tnc mb-3">
        <p>Welcome to americasfinestmaintenance.com!</p>
        <p>
          These terms and conditions outline the rules and regulations for the
          use of America&apos;s Finest Maintenance Company LLC&apos;s Website,
          located at https://americasfinestmaintenance.com/.
        </p>
        <p>
          By accessing this website, we assume you accept these terms and
          conditions. Do not continue to use americasfinestmaintenance.com if
          you do not agree to take all of the terms and conditions stated on
          this page.
        </p>
        <h2 className="text_head">Cookies:</h2>
        <p>
          The website uses cookies to help personalize your online experience.
          By accessing americasfinestmaintenance.com, you agreed to use the
          required cookies.
        </p>
        <p>
        ...
        <p>
          ...
          cookies do not require your consent as they always work. Please keep
          in mind that by accepting required Cookies, you also accept
          third-party Cookies, which might be used via third-party provided
          services if you use such services on our website, for example, a video
          display window provided by third parties and integrated into our
          website.
        </p>
        <h2 className="text_head">License:</h2>
        <p>
          Unless otherwise stated, America&apos;s Finest Maintenance Company LLC
          and/or its licensors own the intellectual property rights for all
          material on americasfinestmaintenance.com. All intellectual property
          rights are reserved. You may access this from
          americasfinestmaintenance.com for your own personal use subjected to
          restrictions set in these terms and conditions.
        </p>
        <p>You must not:</p>
        <ul>
          <li>Copy or republish material from americasfinestmaintenance.com</li>
          <li>
            Sell, rent, or sub-license material from
            americasfinestmaintenance.com
          </li>
          <li>
            Reproduce, duplicate or copy material from
            americasfinestmaintenance.com
          </li>
          <li>Redistribute content from americasfinestmaintenance.com</li>
        </ul>
        ...
        <p>
          ...
          America&apos;s Finest Maintenance Company LLC does not filter, edit,
          publish or review Comments before their presence on the website.
          Comments do not reflect the views and opinions of America&apos;s
          Finest Maintenance Company LLC, its agents, and/or affiliates.
          ...
          America&apos;s Finest Maintenance Company LLC shall not be liable for
        ...
        <p>
          America&apos;s Finest Maintenance Company LLC reserves the right to
          monitor all Comments and remove any Comments that can be considered
        ...
        <p>
          You hereby grant America&apos;s Finest Maintenance Company LLC a
        ...
        <h2 className="text_head">Hyperlinking to our Content:</h2>
        <p>
        ...
        <p>
          ...
          the hyperlink compensates the absence of America&apos;s Finest
          Maintenance Company LLC; and (d) the link is in the context of general
        ...
        <p>
          ...
          sending an e-mail to America&apos;s Finest Maintenance Company LLC.
        ...
        <p>
          No use of America&apos;s Finest Maintenance Company LLC&apos;s logo or
          other artwork will be allowed for linking absent a trademark license
          agreement.
        </p>
        <h2 className="text_head">Content Liability:</h2>
        <p>
        ...
        <h2 className="text_head">Reservation of Rights:</h2>
        <p>
        ...
        <h2 className="text_head">Removal of links from our website:</h2>
        <p>
        ...
        <h2 className="text_head">Disclaimer:</h2>
        <p>
